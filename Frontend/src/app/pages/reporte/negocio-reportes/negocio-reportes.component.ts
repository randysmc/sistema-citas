...
@Component({
  selector: 'app-negocio-reportes',
  templateUrl: './negocio-reportes.component.html',
  styleUrls: ['./negocio-reportes.component.css']
})
export class NegocioReportesComponent {
  reportes: ReporteDTO[] = [];
  negocio: any;
  ...
  constructor(
    ...
    onReporteChange(event: Event): void {
      ...
      } else if (this.selectedReporte === 'usuariosMasCanceladas') {
